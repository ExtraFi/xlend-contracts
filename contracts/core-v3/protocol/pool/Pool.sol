...
contract Pool is VersionedInitializable, PoolStorage, IPool {
  ...
  function liquidationCall(
    ...
    LiquidationLogic.executeLiquidationCall(
      ...
      _usersConfig,
      _eModeCategories,
      DataTypes.ExecuteLiquidationCallParamsV2({
        reservesCount: _reservesCount,
  ...
  function setReserveInterestRateStrategyAddress(
    ...
    PoolLogic.setReserveInterestRateStrategyAddress(
      _reserves,
      _reservesList,
      asset,
      rateStrategyAddress
  ...
  function setReserveTreasury(
    address asset,
    address treasury
  ) external virtual override onlyPoolConfigurator {
    PoolLogic.setReserveTreasury(_reserves, _reservesList, asset, treasury);
  }
  ...
  function updateReserveState(
    ...
    PoolLogic.updateReserveState(_reserves, asset);
  }

  function updateReserveIndexRate(
    address asset
  ) external  virtual override onlyPoolConfigurator {
    PoolLogic.updateReserveIndexRate(_reserves, asset);
  }
