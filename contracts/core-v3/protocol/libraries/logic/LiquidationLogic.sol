...
library LiquidationLogic {
  ...
  function executeLiquidationCall(
    ...
    DataTypes.ExecuteLiquidationCallParamsV2 memory params
  ) external {
    ...
    debtReserve.updateInterestRates(
      vars.debtReserveCache,
      params.debtAsset,
      vars.actualDebtToLiquidate,  //params.repayAToken ? 0 : vars.actualDebtToLiquidate,
      0
    );
    ...
    // if (params.repayAToken) {
    //   IAToken(vars.debtReserveCache.aTokenAddress).burn(
    //     msg.sender,
    //     vars.debtReserveCache.aTokenAddress,
    //     vars.actualDebtToLiquidate,
    //     vars.debtReserveCache.nextLiquidityIndex
    //   );
    // } else 
    {
